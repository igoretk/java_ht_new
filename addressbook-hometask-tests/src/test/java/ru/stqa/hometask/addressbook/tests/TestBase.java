...
public class TestBase {
  ...
  protected void fillingTheForm(DataGroupFilling dataGroupFilling) {
  ...
  protected void secondaryInfoFill(SecondaryInfoData secondaryInfoData) {
  ...
  protected void phoneInfoFill(PhoneInfoData phoneInfoData) {
  ...
  protected void primaryInfoFill(PrimaryInfoData primaryInfoData) {
