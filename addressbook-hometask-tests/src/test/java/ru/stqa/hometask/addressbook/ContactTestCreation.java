...
public class ContactTestCreation {
 ...
 //   Thread.sleep(5000); //temporary just to see what happens in browser
  ...
  private void secondaryInfoFill(SecondaryInfoData secondaryInfoData) {
  ...
  private void phoneInfoFill(PhoneInfoData phoneInfoData) {
  ...
  private void primaryInfoFill(PrimaryInfoData primaryInfoData) {
